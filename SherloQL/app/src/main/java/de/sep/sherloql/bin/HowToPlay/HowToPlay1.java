...
public class HowToPlay1 extends AppCompatActivity {
    ...
    public void initButtons(){
        nexttut2 = (Button) findViewById(R.id.nexttutorial);
        nexttut2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(), HowToPlay2.class);
