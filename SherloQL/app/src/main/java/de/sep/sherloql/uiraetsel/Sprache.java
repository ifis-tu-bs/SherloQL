...
public class Sprache extends AppCompatActivity {
    //Initialize variable
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < raetselArrayList.size(); i++)  {
            if(raetselArrayList.get(i).getCategory().equals("Sprachen")) {
                ...
                rlAdapter = new RaetselListAdapter(this, spracheArrayList);
