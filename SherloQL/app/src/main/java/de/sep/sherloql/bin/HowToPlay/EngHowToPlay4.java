...
public class EngHowToPlay4 extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tutorialx4_eng);
    ...
    public void initButtons(){
        nexttut2 = (Button) findViewById(R.id.tut4to5_eng);
        nexttut2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(), EngHowToPlay5.class);
