...
public class EngHowToPlay7 extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tutorialx7_eng);
    ...
    public void initButtons(){
        nexttut2 = (Button) findViewById(R.id.tut7to8_eng);
        nexttut2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(), EngHowToPlay8.class);
