...
public class Informatik extends AppCompatActivity {
    //Initialize variable
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_informatik);
        ...
        for (int i = 0; i < raetselArrayList.size(); i++)  {
            if(raetselArrayList.get(i).getCategory().equals("SQL")) {
                ...
                rlAdapter = new RaetselListAdapter(this, informatikArrayList);
