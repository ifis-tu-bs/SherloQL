...
public class EngHowToPlay6 extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tutorialx6_eng);
    ...
    public void initButtons(){
        nexttut2 = (Button) findViewById(R.id.tut6to7_eng);
        nexttut2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(), EngHowToPlay7.class);
