...
public class Mathematik extends AppCompatActivity {
    //Initialize variable
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < raetselArrayList.size(); i++)  {
            if(raetselArrayList.get(i).getCategory().equals("Mathematik")) {
                ...
                rlAdapter = new RaetselListAdapter(this, mathematikArrayList);
